"use strict";
//variables. variables. variables. many of them in the rectColor objects. variables.
const width = 400;
const height = 400;
let rectColor = {
    oneR: 20,
...
// draws rectangles with function, checks mouse position and changes color of rectangle accordingly (and resets if not over)
function draw() {
...
//she resents those bourgeois variables up at the top. all the hard work is done down here.
