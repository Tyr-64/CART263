...
function setup() {
    ...
    /***CODE */
    let innerContainerElements = document.getElementsByClassName("inner-container");
    console.log(innerContainerElements);
    /***OUTPUT: 
    ...
    /***CODE */
    let imgContainerElements = document.getElementsByClassName("img-container");
    let imgElement = imgContainerElements[imgContainerElements.length - 1];
    console.log(imgElement.children[0]);
    /***OUTPUT: 
    ...
    let h2ListLength = h2Elements.length;
    let h2TextContent = h2Elements[0];
    console.log(h2Elements);
    console.log(h2ListLength);
